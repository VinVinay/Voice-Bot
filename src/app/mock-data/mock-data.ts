...
export const covid = [
   { serialNo: 1,publicationNumber: 'CN111588720A', title: 'application of atorvastatin calcium in preparation of drugs for treating COVID-19' , dwpiTitle : 'Application of (R-(R,R))-2-(4-fluorophenyl)-beta,beta-dihydroxy-5-(1-methylethyl)-3-phenyl-4-((aniline)carbonyl)-1H-pyrrole-1-heptanoic acid calcium trihydrate compound for preparing drugs for treating coronary pneumonia'},
   { serialNo: 2,publicationNumber: 'CN111603465A', title: 'Application of lovastatin in preparation of medicine for treating new coronal pneumonia' , dwpiTitle : 'Use of lovastatin for preparation drugs for treating new coronary pneumonia'},
   { serialNo: 3,publicationNumber: 'CN111588719A', title: 'Application of simvastatin in preparation of novel coronavirus pneumonia treating drugs' , dwpiTitle : 'Use of simvastatin in preparing medicine for treating new coronary pneumonia'},
 ...
 export const machineLearning = [
   ...
   { serialNo: 7,publicationNumber: 'US10885053B2', title: 'Systems and methods for dynamically rendering data lineage' , dwpiTitle : 'New isolated severe acute respiratory syndrome coronavirus protein binding molecule against viral infection useful e.g. for preparing composition or detecting product, comprising e.g. heavy chain and light chain variable region'},
   { serialNo: 8,publicationNumber: 'US10893330B2', title: 'Concurrent presentation of non-programming media assets with programming media content at client device' , dwpiTitle : 'Remote intelligent inch ruler pulse diagnosis device, has consultation terminal provided with impulse terminal and connected with virtual reality hardware technology device for determining desired data'},
   { serialNo: 9,publicationNumber: 'EP3757548A1', title: 'REFLECTION CHARACTERISTIC MEASUREMENT DEVICE, CORRESPONDING METHOD AND NON-TRANSITORY STORAGE MEDIUM' , dwpiTitle : 'Facial contact mask has hook strap that is installed through side portion so that first through hole moves along hook strap, where hook strap is not removed from first through hole, by installing hook strap through first through hole'},
   { serialNo: 10,publicationNumber: 'EP3740881A1', title: 'CONTEXT-SENSITIVE METHODS OF SURFACING COMPREHENSIVE KNOWLEDGE IN AND BETWEEN APPLICATIONS', dwpiTitle : 'Device for detecting/monitoring a physiological condition/biological phenomena comprises needle assembly having a needle body with radiation ports, electromagnetic radiation carrier, radiation source and electromagnetic radiation detector'},
 ];
 
export const fiveG = [
   { serialNo: 1,publicationNumber: 'US10973979B2', title: 'Blood glucose control system with control parameter modification' , dwpiTitle : 'Device for detecting/monitoring a physiological condition/biological phenomena comprises needle assembly having a needle body with radiation ports, electromagnetic radiation carrier, radiation source and electromagnetic radiation detector'},
   { serialNo: 2,publicationNumber: 'US10966233B2', title: 'Methods and devices for information transmission' , dwpiTitle : 'Steam condensation system, has recoverer connected with heating device, where heating device and recoverer are provided with press, and recoverer is connected with self-control box and provided with pressure gauge and temperature gauge'},
   { serialNo: 3,publicationNumber: 'US10944509B2', title: 'Method to generate ordered sequence for polar codes' , dwpiTitle : 'Breathing apparatus supplying oxygen has mask, air conduits and breathing bag in form of oxygen generator including light impenetrable and penetrable shells'},
   { serialNo: 4,publicationNumber: 'US10966975B2', title: 'Smart broadcast device' , dwpiTitle : 'Device for detecting/monitoring a physiological condition/biological phenomena comprises needle assembly having a needle body with radiation ports, electromagnetic radiation carrier, radiation source and electromagnetic radiation detector'},
   { serialNo: 5,publicationNumber: 'US10923819B2', title: 'Antenna system and terminal' , dwpiTitle : 'Steam condensation system, has recoverer connected with heating device, where heating device and recoverer are provided with press, and recoverer is connected with self-control box and provided with pressure gauge and temperature gauge'},
   { serialNo: 6,publicationNumber: 'US10958245B2', title: 'Acoustic filter using acoustic coupling' , dwpiTitle : 'Breathing apparatus supplying oxygen has mask, air conduits and breathing bag in form of oxygen generator including light impenetrable and penetrable shells'},
   { serialNo: 7,publicationNumber: 'US10963452B2', title: 'Asset management method and apparatus, and electronic device' , dwpiTitle : 'Device for detecting/monitoring a physiological condition/biological phenomena comprises needle assembly having a needle body with radiation ports, electromagnetic radiation carrier, radiation source and electromagnetic radiation detector'},
   { serialNo: 8,publicationNumber: 'US10972136B2', title: 'Polar code rate matching method and apparatus' , dwpiTitle : 'Steam condensation system, has recoverer connected with heating device, where heating device and recoverer are provided with press, and recoverer is connected with self-control box and provided with pressure gauge and temperature gauge'},
   { serialNo: 9,publicationNumber: 'CN111208925A', title: 'Method for establishing application combination and electronic equipment' , dwpiTitle : 'Breathing apparatus supplying oxygen has mask, air conduits and breathing bag in form of oxygen generator including light impenetrable and penetrable shells'},
   { serialNo: 10,publicationNumber: 'US10952218B2', title: 'BWP switching method and apparatus, and terminal device' , dwpiTitle : 'Breathing apparatus supplying oxygen has mask, air conduits and breathing bag in form of oxygen generator including light impenetrable and penetrable shells'},
 ];
...
export const oxygenHuman = [
    { serialNo: 1, publicationNumber: 'WO2004026363A2', title: 'NEEDLE WITH FIBEROPTIC CAPABILITY' , dwpiTitle : 'Device for detecting/monitoring a physiological condition/biological phenomena comprises needle assembly having a needle body with radiation ports, electromagnetic radiation carrier, radiation source and electromagnetic radiation detector'},
     ...
     { serialNo: 4, publicationNumber: 'RU1612396C', title: 'MINIATURE PULMONARY AUTOMATE' , dwpiTitle : 'Small-size breathing apparatus incorporates rigid spring loaded membrane to cover by-pass channel nozzle'},
     { serialNo: 5, publicationNumber: 'CN201088759Y', title: 'Artificial respiration oxygen booster for rescuing infectious patient' , dwpiTitle : 'Artificial respiration oxygen enriching apparatus for use in infectious patients rescuing process, has inlet oxygen pipe with valve immovably connected with rescue breathing pipe, and round ceil fixed on rescue breathing pipe'},
     { serialNo: 6, publicationNumber: 'CN201123315Y', title: 'Simple oxygenation machine' , dwpiTitle : 'Simple oxygenator useful for industrial applications, comprises upper oxygen transfer bottle, lower oxygen transfer bottle, water conduit, and oxygen conduit'},
     { serialNo: 7, publicationNumber: 'RU1612396C', title: 'MINIATURE PULMONARY AUTOMATE' , dwpiTitle : 'Small-size breathing apparatus incorporates rigid spring loaded membrane to cover by-pass channel nozzle'},
     { serialNo: 8, publicationNumber: 'CN201088759Y', title: 'Artificial respiration oxygen booster for rescuing infectious patient' , dwpiTitle : 'Artificial respiration oxygen enriching apparatus for use in infectious patients rescuing process, has inlet oxygen pipe with valve immovably connected with rescue breathing pipe, and round ceil fixed on rescue breathing pipe'},
     { serialNo: 9, publicationNumber: 'CN201123315Y', title: 'Simple oxygenation machine' , dwpiTitle : 'Simple oxygenator useful for industrial applications, comprises upper oxygen transfer bottle, lower oxygen transfer bottle, water conduit, and oxygen conduit'},
     { serialNo: 10, publicationNumber: 'RU1612396C', title: 'MINIATURE PULMONARY AUTOMATE' , dwpiTitle : 'Small-size breathing apparatus incorporates rigid spring loaded membrane to cover by-pass channel nozzle'},
     { serialNo: 11, publicationNumber: 'CN201088759Y', title: 'Artificial respiration oxygen booster for rescuing infectious patient' , dwpiTitle : 'Artificial respiration oxygen enriching apparatus for use in infectious patients rescuing process, has inlet oxygen pipe with valve immovably connected with rescue breathing pipe, and round ceil fixed on rescue breathing pipe'},
     { serialNo: 12, publicationNumber: 'CN201123315Y', title: 'Simple oxygenation machine' , dwpiTitle : 'Simple oxygenator useful for industrial applications, comprises upper oxygen transfer bottle, lower oxygen transfer bottle, water conduit, and oxygen conduit'},
  ];
